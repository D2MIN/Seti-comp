...
int main() {
	...
	const char* nameN = "C:/Users/s0177102/source/repos/file/REQUEST.bin";
	const char* nameA = "C:/Users/s0177102/source/repos/file/ANSWER.bin";
	...
	while (true)
	{
		...
		size_pred_name = fN.tellg();
		fN.close();
		string s = "C:/Users/s0177102/source/repos/file/" + B.name + ".bin";
		...
		cout << "Сервер обработал данные и отправил клиенту ответ" << endl;
